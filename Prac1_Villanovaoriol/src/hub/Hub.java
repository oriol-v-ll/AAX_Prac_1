...
/**
 * En esta clase se implementa el main para que el hub proporciona a cada
 * cliente la IP de su edgeserver Optimo. Si la ubicación no esta en el rango
 * del edge server se envia la IP del Origin.
 * 
 * @author oriol
 *
 */
